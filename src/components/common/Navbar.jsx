...
const Navbar = () => {
    ...
    return (
        <div className=' w-full flex flex-row  items-center bg-[#01C6B5] text-white justify-between py-2 px-5 lg:px-35 relative'>
            ...
            <div className={`fixed md:hidden top-0 right-0 h-screen w-64 bg-[#01C6B5] flex flex-col items-center gap-8 pt-20 z-50 transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
