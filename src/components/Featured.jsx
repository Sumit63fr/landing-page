...
const Featured = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-full mt-12 sm:mt-16 md:mt-20 lg:mt-24 px-4 sm:px-6 md:px-8'>
            ...
            <div
                className='mt-8 sm:mt-10 md:mt-12 overflow-hidden w-full max-w-full'
            ...
            >
                ...
                >
                    {allCards.map((item, index) => (
                        <div
                            key={index}
                            className='bg-[#F5F5F5] flex-shrink-0 flex flex-col cursor-pointer hover:shadow-lg transition-shadow relative group rounded-lg overflow-hidden'
