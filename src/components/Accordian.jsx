...
const Accordian = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center mt-12 sm:mt-16 md:mt-20 lg:mt-24 lg:px-35 px-5'>
            <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-semibold text-center'>Frequently Asked Questions</h1>
            <p className='text-sm sm:text-base md:text-[16px] font-normal text-[#414143] mt-2 sm:mt-3 md:mt-4 text-center max-w-2xl'>Real Questions. Expert Answers. Total Confidence.</p>
                ...
                {accordion.map((item, index) => (
                    ...
                    >
                        <div className='flex flex-col'>
                            ...
                            >
                                <h4 className='font-medium text-base sm:text-lg md:text-xl lg:text-xl pr-3 flex-1 break-words'>{item.title}</h4>
